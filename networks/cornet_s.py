...
# Get pretrained weights of CORnet_S from GitHub: https://github.com/dicarlolab/CORnet
"""
...
def cornet_s(pretrained=False, **kwargs):
    ...
    model = CORnet_S()
    if pretrained:
        model.load_state_dict(model_zoo.load_url("https://s3.amazonaws.com/cornet-models/cornet_s-1d3f7974.pth"),
                              strict=False)
    return model