...
vgg_feat_list = ['Conv2d_1', 'BatchNorm2d_1', 'ReLU_1', 'Conv2d_2', 'BatchNorm2d_2', 'ReLU_2', 'MaxPool2d_1', 'Conv2d_3',
                 'BatchNorm2d_3', 'ReLU_3', 'Conv2d_4', 'BatchNorm2d_4', 'ReLU_4', 'MaxPool2d_2', 'Conv2d_5', 'BatchNorm2d_5',
                 'ReLU_5', 'Conv2d_6', 'BatchNorm2d_6', 'ReLU_6', 'MaxPool2d_3', 'Conv2d_7', 'BatchNorm2d_7', 'ReLU_7',
                 'Conv2d_8', 'BatchNorm2d_8', 'ReLU_8', 'MaxPool2d_4', 'Conv2d_9', 'BatchNorm2d_9', 'ReLU_9', 'Conv2d_10',
                 'BatchNorm2d_10', 'ReLU_10', 'MaxPooul2d_1']


vgg_classifier_list = ['fc6','ReLU6','Dropout6','fc7','ReLU7','Dropout7','fc8']

class VGG13_bnNet(nn.Module):
    def __init__(self,is_pretrained):
        """Select conv1_1 ~ conv5_1 activation maps."""
        super(VGG13_bnNet, self).__init__()
        ...
        self.vgg_feats = models.vgg13_bn(pretrained=is_pretrained).features
        self.vgg_classifier = models.vgg13_bn(pretrained=is_pretrained).classifier
