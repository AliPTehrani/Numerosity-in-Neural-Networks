...
vgg_feat_list = ['conv1_1','ReLU1_1','maxpool', "Conv1_2",'ReLU1_2','maxpool1',\
'conv2_1','ReLU2_1','conv2_2','ReLU2_2','maxpool2',\
'conv3_1','ReLU3_1','conv3_2','ReLU3_2','maxpool3',
'conv4_1','ReLU4_1','conv4_2','ReLU4_2','maxpool4']
...
class VGG11Net(nn.Module):
    def __init__(self,is_pretrained):
        ...
        self.vgg_feats = models.vgg11(pretrained=is_pretrained).features
        self.vgg_classifier = models.vgg11(pretrained=is_pretrained).classifier
