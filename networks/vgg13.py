...
vgg_feat_list = ['Conv2d_1', 'ReLU_1', 'Conv2d_2', 'ReLU_2', 'MaxPool2d_1', 'Conv2d_3', 'ReLU_3', 'Conv2d_4',
                 'ReLU_4', 'MaxPool2d_2', 'Conv2d_5', 'ReLU_5', 'Conv2d_6', 'ReLU_6', 'MaxPool2d_3', 'Conv2d_7',
                 'ReLU_7', 'Conv2d_8', 'ReLU_8', 'MaxPool2d_4', 'Conv2d_9', 'ReLU_9', 'Conv2d_10', 'ReLU_10', 'MaxPool2d_5']
...
class VGG13Net(nn.Module):
    def __init__(self,is_pretrained):
        ...
        self.vgg_feats = models.vgg13(pretrained=is_pretrained).features
        self.vgg_classifier = models.vgg13(pretrained=is_pretrained).classifier
